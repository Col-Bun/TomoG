...
const MONSTER_SPECIES = {
  ...
  raichu: {
    ...
    walkSpeed: 0.95,
    anims: {
      Walk:  { w: 40, h: 48, dirs: 8, dur: [8,10,8,10] },
      Idle:  { w: 40, h: 56, dirs: 8, dur: [40,2,4,4,4,2] },
      Sleep: { w: 32, h: 40, dirs: 1, dur: [30,35] },
      Sit:   { w: 32, h: 40, dirs: 1, dur: [8,8,8] },
      Eat:   { w: 32, h: 48, dirs: 1, dur: [6,8,6,8] },
    },
    bubbles: ['ライチュウ！', 'rai~', '⚡⚡', 'zap zap', '…', '¡rayo!'],
  },
  sandshrew: {
    id: 'sandshrew',
    label: 'Sandshrew',
    jp: 'サンド',
    es: 'Sandshrew',
    dir: 'monsters/sandshrew',
    scale: 2.0,
    walkSpeed: 0.7,
    anims: {
      Walk:  { w: 32, h: 32, dirs: 8, dur: [6,10,6,10] },
      Idle:  { w: 32, h: 40, dirs: 8, dur: [40,2,2,2] },
      Sleep: { w: 24, h: 32, dirs: 1, dur: [30,35] },
      Sit:   { w: 24, h: 32, dirs: 1, dur: [8,8,8] },
      Eat:   { w: 24, h: 32, dirs: 1, dur: [6,8,6,8] },
    },
    bubbles: ['サンド！', 'shrew~', '🏜️', 'curl up', '…', 'arenita'],
  },
  sandslash: {
    id: 'sandslash',
    label: 'Sandslash',
    jp: 'サンドパン',
    es: 'Sandslash',
    dir: 'monsters/sandslash',
    scale: 2.0,
    walkSpeed: 0.85,
    anims: {
      Walk:  { w: 32, h: 40, dirs: 8, dur: [8,10,8,10] },
      Idle:  { w: 32, h: 40, dirs: 8, dur: [25,10,25,10] },
      Sleep: { w: 24, h: 32, dirs: 1, dur: [30,35] },
      Sit:   { w: 24, h: 40, dirs: 1, dur: [8,8,8] },
      Eat:   { w: 24, h: 40, dirs: 1, dur: [6,8,6,8] },
    },
    bubbles: ['サンドパン！', 'slash~', '⚔️', '*claws*', '…', 'gríngale'],
  },
  vulpix: {
    id: 'vulpix',
    label: 'Vulpix',
    ...
    walkSpeed: 0.8,
    anims: {
      Walk:  { w: 32, h: 40, dirs: 8, dur: [6,4,4,4,6] },
      Idle:  { w: 32, h: 32, dirs: 8, dur: [40,12,20,12] },
      Sleep: { w: 24, h: 24, dirs: 1, dur: [30,35] },
      Sit:   { w: 24, h: 32, dirs: 1, dur: [8,8,8] },
      Eat:   { w: 24, h: 24, dirs: 1, dur: [6,8,6,8] },
    },
    bubbles: ['ロコン！', 'vul~', '🔥🦊', 'wisp wisp', '…', 'zorrito'],
  },
};
